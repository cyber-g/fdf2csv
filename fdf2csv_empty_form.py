#!/usr/bin/python
#title           :fdf2csv_empty_form.py
#description     :Extract all data from FDF file of empty form to a CSV file
#author          :cyber-g
#version         :0.5.1
#usage           :python fdf2csv_empty_form.py file.fdf
#=================================================
...
arglen = len(sys.argv)
if not arglen == 2:
    print("Usage: fdf2csv_empty_form.py file.fdf")
    sys.exit()
